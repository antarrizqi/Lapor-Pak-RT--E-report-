                    ...
                    <div class="bg-white shadow-lg rounded-lg md:mx-auto my-4 max-w-2xl">
                        <div class="px-12 py-6 ">
                            <div class="flex items-center justify-between">
                                <h2 class="text-lg font-semibold text-gray-900 -mt-1">mas surya</h2>
                            </div>
                        ...
                        <div class="px-12 py-6 border-t-2">
                            <div class="flex items-center justify-between">
                                <h2 class="text-lg font-semibold text-gray-900 -mt-1">mas jono</h2>
                        ...
                        <div class="px-12 py-6 border-t-2">
                            <div class="flex items-center justify-between">
                                <h2 class="text-lg font-semibold text-gray-900 -mt-1">mas adam</h2>
                                <small class="text-sm text-gray-700">22h ago</small>
                            </div>
                            <p class="text-gray-700">Joined 12 SEP 2012.</p>
                            <p class="mt-3 text-gray-700 text-sm">
